          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <div class="card-body table-responsive">
              	@can('isAdmin')   
                <div class="btn-group">
                <a href="{{url('/control-area/add-menu')}}" class="btn btn-exp btn-sm m-0 "  data-toggle="modal" data-target="#myModal" > Add Menus</a> 
                </div>
              	<div class="btn-group">
        ...
        $('#myTable').DataTable({
           ...
           "order": [[ 1, "desc" ]],
                ...
                columns: [
                    ...
                    {data: 'menuname',orderable: false},
                    {data: 'menusku',orderable: false}, 
                    {data: 'menuprice',orderable: false},  
                    {data: 'menuimage',orderable: false}, 
                    {data: 'menustatus',orderable: false},  
                    {data: 'menucreated_at',orderable: false},
